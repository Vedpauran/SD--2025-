...
function Blogpagecontentupdate() {
	...
	function fetchdata() {
		try {
			axios
				.get(`${process.env.REACT_APP_SERVER}page/blog/${id}`)
				.then((res) => {
	...
	const Savedata = async (e) => {
		e.preventDefault();
		try {
			const Api = `${process.env.REACT_APP_SERVER}page/blog/${id}`;
			await axios
				.put(Api, Page)
				.then((res) => {
					const notify = () =>
...
export default Blogpagecontentupdate;
