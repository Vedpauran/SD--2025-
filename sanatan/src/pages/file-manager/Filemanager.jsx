    ...
    <>
      {isDeleteModal && (
        <div className="modal-del">
          <div className="warn-text">Are you sure you want to delete ?</div>
          <div className="model-btns">
            <button onClick={closeDeleteModal} className="close-del">
              Close
            </button>
            <button onClick={(e) => onDelete()} className="modal-delbtn">
              Delete
            </button>
          </div>
        </div>
      ...
      <div className="Card tablecard">
        <div className="drop-col">
          ...
          >
            ...
            />
            <p>
              <span className="txtprimary">Upload a file</span>or drag and drop
            </p>
      ...
      <div className="Card tablecard">
        <div className="cardhead">
          <div className="tabbar">
            <button
              className={fileType === "" ? "tab-btn" : "tab-btn btnoutline"}
              onClick={() => setfileType("")}
            >
            ...
            <button
              className={
                fileType === "video" ? "tab-btn" : "tab-btn btnoutline"
              }
            ...
            <button
              className={
                fileType === "audio" ? "tab-btn" : "tab-btn btnoutline"
              }
            ...
            <button
              className={
                fileType === "image" ? "tab-btn" : "tab-btn btnoutline"
              }
            ...
            <button
              className={fileType === "svg" ? "tab-btn" : "tab-btn btnoutline"}
        ...
        <div className="Img-Gallery">
          {Gallery.map((data, i) => {
            ...
            return (
              <div key={i}>{getFileType(data.name, data._id, data.path)}</div>
            );
          })}
        </div>
