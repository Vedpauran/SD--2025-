...
// Define the MongoClient instance at the top of the file
...
//     try {
//         // Check if category already exists in the main Category collection
//         const existingCategory = await Category.findOne({ Name });
//         if (existingCategory) {
//             return res.status(400).json({ message: "Category already exists" });
//         }
...
//         // Check if the collection with the category name already exists in the database
//         const collections = await db.listCollections().toArray();
//         const collectionNames = collections.map(col => col.name);

//         if (!collectionNames.includes(Name)) {
//             // Create a new collection named after the category
...
//         // Create a new document in the main Category collection
//         const category = new Category({ Name, ...otherData });
//         const newCategory = await category.save();
