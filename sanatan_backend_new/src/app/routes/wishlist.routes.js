...
//     if (type === "Page") {
//       return await getPages(req.user._id, req.query.language, res);
//     }
//     if (type === "Blog") {
//       return await getBlogs(req.user._id, req.query.language, res);
//     }
//     if (type === "Donation") {
//       return await getDonations(req.user._id, req.query.language, res);
//     }
...
async function getBlogs(userid, langid, res) {
  try {
    const currentDate = new Date(); // 🛠️ Fix: Define currentDate
