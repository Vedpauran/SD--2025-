...
router.delete("/:id", async (req, res) => {
  const _id = req.params.id;
  try {
    const deletePage = await Pages.deleteOne({
      _id
    });
    res.status(200).json({
      msg: "Successfully Deleted"
...
router.put("/aarti/:id", async (req, res) => {
  const _id = req.params.id;
  try {
    const AartiUpdate = await AartiContent.findByIdAndUpdate(_id, req.body);
    res.status(200).json({
...
router.put("/temple/:id", async (req, res) => {
  const _id = req.params.id;
  try {
    const TempleUpdate = await TempleContent.findByIdAndUpdate(_id, req.body);
    res.status(200).json({
      msg: "Successfully Updated"
    });
  } catch (error) {
...
router.put("/extra/:id", async (req, res) => {
  const _id = req.params.id;
  try {
    const ExtraUpdate = await ExtraContent.findByIdAndUpdate(_id, req.body);
    res.status(200).json({
      msg: "Successfully Updated"
    });
  } catch (error) {
...
router.put("/blog/:id", async (req, res) => {
  const _id = req.params.id;
  try {
    const BlogUpdate = await BlogContent.findByIdAndUpdate(_id, req.body);
    res.status(200).json({
      msg: "Successfully Updated"
    });
  } catch (error) {
...
router.put("/scripture/:id", async (req, res) => {
  const _id = req.params.id;
  try {
    const ScriptureUpdate = await ScriptureContent.findByIdAndUpdate(_id, req.body);
    res.status(200).json({
      msg: "Successfully Updated"
    });
  } catch (error) {
