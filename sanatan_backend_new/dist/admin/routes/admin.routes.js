...
app.use("/whatsnew/content", verifyJWT, require("./whatsnew/whatsnewContent.routes"));
app.use("/notification", verifyJWT, require("./notification/notification.routes"));
app.use("/notification/content", verifyJWT, require("./notification/notificationcontent.routes"));
...
app.use("/page/extra", verifyJWT, require("./pages/extrapages/extrapages.routes"));
app.use("/page/scripture", verifyJWT, require("./pages/scriptures/scriptures.routes"));
app.use("/page/scripture2", verifyJWT, require("./pages/scriptures/scriptures2.routes"));
